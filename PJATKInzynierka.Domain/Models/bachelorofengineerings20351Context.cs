...
{
    public partial class bachelorofengineerings20351Context : DbContext
    {
        public bachelorofengineerings20351Context()
        {
        }

        public bachelorofengineerings20351Context(DbContextOptions<bachelorofengineerings20351Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:bachelor-of-engineering-s20351.database.windows.net,1433;Initial Catalog=bachelor-of-engineering-s20351;Persist Security Info=False;User ID=s20351;Password=adminadmin1.;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Term>(entity =>
            {
                ...
                entity.HasIndex(e => e.Date, "UQ__Term__77387D070137E14E")
                    .IsUnique();
